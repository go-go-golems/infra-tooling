# Generic go-go-golems dependency bump target for repositories that should
# validate against published modules only. This variant forces GOWORK=off so a
# local go.work cannot hide missing upstream releases.
