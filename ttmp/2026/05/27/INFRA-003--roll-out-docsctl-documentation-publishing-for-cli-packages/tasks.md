...
- [x] Implement ggg run status for single-repository GitHub Actions polling with ignored failure support
- [x] Implement ggg batch actions for multi-repository GitHub Actions status from a YAML manifest
- [x] Document the GitHub Actions status helper design and release-train usage
